...
module.exports = class Generator {
    ...
    runTask() {
        const { folderPath, modelPath } = this.options;
        ...
        return new Promise((resolve, reject) => {
            fileOverwrite(folderPath).then(() => {
                ...
                fileStr = this.taskRaplaces(contentStr);
    ...
    taskRaplaces(contentStr) {
        const { task, name } = this.options;
