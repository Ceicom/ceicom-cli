...
module.exports = class Generator {
    ...
    page() {
        ...
        const task = new Task({ folderPath, modelPath, ...this.options, type: 'page' });
    ...
    template() {
        ...
        const task = new Task({ folderPath, modelPath, ...this.options, type: 'template' });
    ...
    less() {
        ...
        const task = new Task({ folderPath, ...this.options, type: 'less' });
    ...
    webform(isCombo) {
        ...
        const taskAspx = new Task({ modelPath, folderPath, isCombo, ...this.options, type: 'webform' });
    ...
    _webformcs() {
        ...
        const taskAspxCs = new Task({ modelPath, folderPath, ...this.options, type: 'webform' });
